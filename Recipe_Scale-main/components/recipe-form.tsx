      ...
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h2 className="font-serif text-xl text-foreground">
            {isEditing ? t("edit_recipe") : t("add_new_recipe")}
          </h2>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <div className="flex items-start gap-4">
            ...
            <p className="pt-1 text-xs text-muted-foreground leading-relaxed">
              તમારી રેસીપીનો ફોટો અપલોડ કરો. JPG, PNG અથવા WebP સ્વીકારવામાં આવે છે. આ વૈકલ્પિક છે, પરંતુ તે તમને રેસીપી ઓળખવામાં મદદ કરે છે.
            </p>
          </div>
        </div>
          ...
          <div className="space-y-3">
            {ingredients.map((ing, i) => (
                ...
                >
                  ...
                  <div className="md:col-span-3 md:border-l md:border-border md:pl-4">
                    <Label className="mb-1.5 block text-sm font-medium text-foreground">
                      {i === 0 ? "Amount" : ""}
                    </Label>
                    <Input
                  ...
                  <div className="md:col-span-2 md:border-l md:border-border md:pl-4">
                    <Label className="mb-1.5 block text-sm font-medium text-foreground">
                      {i === 0 ? "Unit" : ""}
                    </Label>
                    <Select
                  ...
                  <div className="md:col-span-1 flex items-end md:border-l md:border-border md:pl-3">
                    <Button
                      type="button"
                      variant="ghost"
                      size="icon"
        ...
        <div className="flex justify-end gap-3">
          ...
          <Button type="submit" className="gap-2" disabled={isSaving}>
            ...
            {isSaving ? (isEditing ? t("updating") : t("saving")) : isEditing ? t("update_recipe") : t("save_recipe")}
          </Button>
        </div>
      </form>
    </div>
